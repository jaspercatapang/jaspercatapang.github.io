...
const PUBLICATION_CARDS = [
  ...
  { category: 'conference', title: 'Explaining Bias in Internal Representations of Large Language Models via Concept Activation Vectors', authors: 'Catapang, J.K.', monthYear: '2025', venue: 'NLDB 2025 · Kanazawa, Japan', citation: 'Catapang, J.K. (2025). <em>Explaining Bias in Internal Representations of Large Language Models via Concept Activation Vectors</em>. In: Ichise, R. (eds) Natural Language Processing and Information Systems. NLDB 2025. LNCS, vol 15836. Springer, Cham. <a href="https://doi.org/10.1007/978-3-031-97141-9_8" target="_blank" rel="noopener noreferrer" class="text-accent hover:underline">DOI: 10.1007/978-3-031-97141-9_8</a>', pdfUrl: '/publications/explaining-bias-cav-nldb-2025.pdf', codeUrl: 'https://github.com/jcatapang/bias-cavs', tags: ['LLMs', 'machine learning', 'AI safety'] },
